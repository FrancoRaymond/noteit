...
const Navbar = () => {
  return (
    <div className='py-1.5 w-full bg-gray-900 fixed top-0 left-0 px-2 sm:px-5 md:px-10 lg:px-24 flex justify-between items-center'>
        ...
        <Link to='/create' className='flex items-center bg-amber-400 px-2 py-1 gap-1.5 rounded-md cursor-pointer transition duration-200 active:scale-105 hover:bg-amber-500'>
